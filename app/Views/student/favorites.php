        ...
        container.innerHTML = jobs.map(job => `
            <div class="data-card" style="margin:0;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1.25rem;">
                ...
                <div class="row-actions">
                    ...
                    <button onclick="handleRemoveFavorite('${escapeHtml(job.id)}')" class="btn btn-sm row-action-btn" style="background:#fff;border:1px solid var(--border);color:var(--text-muted);" title="Bỏ lưu việc làm">
                        Bỏ lưu
                    </button>
                </div>
            </div>
